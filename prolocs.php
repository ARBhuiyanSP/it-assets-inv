                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mt-4 mb-4">
                            ...
                            <li class="breadcrumb-item active">Project/Location List</li>
                        </ol>
						<!--  +++++++++++++++ Url/Breadcrumb ++++++++++++++ -->
                        <div class="card mb-4">
								...
								<div class="row">
								  ...
								  <div class="col-md-8">
									...
									<table class="table table-hover" id="datatablesSimple">
										...
										<tbody>
										<?php
											$projectsData = getTableDataByTableName('prolocs');
											...
											<tr>
												...
												<td>
												<?php 
												$dataresult =   getDataRowByTableAndId('departments', $data['department_id']);
												echo (isset($dataresult) && !empty($dataresult) ? $dataresult->department_name : ''); 
												?>
												</td>
												<td><?php echo $data['proloc_name']; ?></td>
												<td>
