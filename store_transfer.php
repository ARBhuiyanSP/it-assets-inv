                                ...
                                <div class="form-group">
									<form action="" method="post" name="add_name" id="transfer_entry_form" onsubmit="showFormIsProcessing('transfer_entry_form');">
										<div class="row" id="div1" style="">
											...
											<div class="col-xs-3">
												<div class="form-group">
														...
														<?php  
															...
															$dataresult =   getDataRowByTableAndId('store', $warehouse_id);
														?>
														<input type="text" class="form-control" readonly="readonly" value="<?php echo (isset($dataresult) && !empty($dataresult) ? $dataresult->name : ''); ?>">
														
														<input type="hidden" name="from_store" id="from_store" class="form-control" readonly="readonly" value="<?php echo $_SESSION['logged']['store_id']; ?>">
											...
											<!-- <div class="col-xs-3">
												<div class="form-group">
													<label for="id">From Store </label>
													<select class="form-control" id="from_store" name="from_store" required>
											...
											<div class="col-xs-3">
												<div class="form-group">
													<label for="id">To Store </label>
													<select class="form-control" id="to_store" name="to_store" required>
														<option value="">Select</option>
														<?php
														$projectsData = getTableDataByTableName('store');
											...
											<div class="col-xs-12">
												<div class="form-group">
													<div class="modal-footer">
														<input type="submit" name="store_transfer_submit" id="submit" class="btn btn-block"  style="background-color:#007BFF;color:#ffffff;" value="SAVE" />
													</div>    
												</div>
											</div>
										</div> 
