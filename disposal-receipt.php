                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mt-4 mb-4">
                            ...
                            <li class="breadcrumb-item active">Disposal Receipt</li>
                        </ol>
						<!--  +++++++++++++++ Url/Breadcrumb ++++++++++++++ -->
                        <div class="card mb-4">
										...
										<div class="col-md-12" id="printableArea">
											<div class="row">
												...
												<div class="col-sm-12">	
													...
													<table style="" class="table table-bordered">
														<tr>
															<td style="width:20%">Disposal date:</td>
															<td><?php 
														...
														<tr>
															<td style="width:20%">Disposal Value:</td>
												...
												<center><div class="row">
													<div class="col-xs-6"></br>
														<?php if($row['disposal_by']){ 
																	
																		$employee_id = $row['disposal_by'];
													...
													</br>--------------------</br>Disposal By</div>
													<div class="col-xs-6"></br></br>--------------------</br>Checked By</div>
												</div></center></br>
												<div class="row">
